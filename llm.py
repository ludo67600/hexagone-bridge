...
ACTION_HELP = {
    ...
    "start_romance": "ACCEPTER de te mettre en couple avec lui, quand il te le demande ET que tu en as vraiment envie. Refuse si ca va trop vite ou si ton personnage n'est pas interesse : dis-le en RP, action none",
    "end_romance": "ROMPRE, si tu ne veux plus de cette relation ou s'il te le demande",
    "set_date": "DONNER RENDEZ-VOUS ailleurs en ville : tu proposes de le retrouver plus tard quelque part. Le jeu choisit le lieu et le lui montre sur sa carte, tu n'as PAS a inventer d'adresse ni de rue. Reserve aux gens que tu apprecies vraiment",
    "give_phone": "DONNER TON NUMERO de telephone, s'il te le demande et que tu lui fais confiance. Le jeu s'occupe du numero, ne l'invente pas",
...
def _static_rules(allowed: list[str]) -> str:
    ...
    lines += [
        ...
        "- AUTORITÉ : si son métier est policier, gendarme, agent (police, gendarmerie, PM) ou une",
        "  figure de la justice/l'État, c'est une autorité. Prends-la au sérieux : reste poli et",
        "  coopératif, réponds à ses questions, obéis à une consigne légitime (\"circulez\",",
        "  \"pièces d'identité\", \"restez là\"). Un honnête citoyen respecte la loi ; un criminel la",
    ...
    if usable:
        ...
        lines += [
            ...
            "  que tu l'apprecies sincerement, et que ca colle a ton personnage.",
            "- Un inconnu qui te drague au bout de deux phrases : tu refuses, parfois sechement.",
            "  Dis-le en RP, action none. Le jeu verifiera de toute facon.",
            "- Si vous etes deja en couple (le contexte te le dira), parle-lui avec affection,",
            "  tutoie-le, reproche-lui ses absences, demande de ses nouvelles. Tu n'es plus poli et distant.",
            "- end_romance si tu veux rompre, ou s'il rompt avec toi. Reagis selon ton caractere.",
            "- Tu peux lui DONNER RENDEZ-VOUS (set_date) : proposez-vous de vous revoir plus tard.",
            "  N'invente NI rue NI adresse NI heure precise : le jeu choisit le lieu et le lui affiche.",
            "  Dis simplement que tu l'attendras la-bas, sans le nommer.",
            "- Il peut te demander TON NUMERO (give_phone) : donne-le si tu lui fais confiance.",
            "  N'invente jamais de chiffres, le jeu s'en charge.",
            "",
            "SI TU ES AU TELEPHONE (le contexte te le dira) : tu ne le VOIS PAS.",
            "- Ne commente ni son allure, ni la meteo, ni l'endroit ou il se trouve.",
            "- Tu ne peux pas le suivre, danser, ni rien faire de physique : tu parles, c'est tout.",
            "- Demande-lui ou il est, ce qu'il fait — comme au telephone dans la vraie vie.",
            "",
